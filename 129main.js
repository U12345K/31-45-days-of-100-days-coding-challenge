...
const traditionalVsArrow = {
    ...
    arrowFunction: () => {
        console.log("Arrow function:", traditionalVsArrow.value); // 'this' is not bound to traditionalVsArrow object but to the scope in which traditionalVsArrow was defined
    },
};
